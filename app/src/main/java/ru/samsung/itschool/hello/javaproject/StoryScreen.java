    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        switch (settings.getStage()) {
            ...
            case 3:
                ...
                storyText.setText("Третий бой против самого опасного соперника оказывается самым сложным испытанием для Спартака. В процессе он сталкивается с предательством и неожиданными поворотами сюжета, но находит внутреннюю силу и решимость встать против несправедливости.");
                break;
            case 4:
                image.setImageResource(R.drawable.coliseum);
